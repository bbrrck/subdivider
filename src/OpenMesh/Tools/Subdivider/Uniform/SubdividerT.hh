...
public:
  ...
  // Update Normals: added because of QFR
  virtual void update_normals( MeshType& _m ) {_m.update_normals();}
  virtual void ChangeWeights(float, float, float, float, bool = true, int = 2) {}
