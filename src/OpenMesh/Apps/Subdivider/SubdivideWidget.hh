...
private slots:
  ...
  void slot_select_vertexPick(int);

  void slot_vWi_change(QString);
  void slot_vWf_change(QString);
  void slot_nWi_change(QString);
  void slot_nWf_change(QString);
  void slot_nNN_change(int);

private:
	
	int vertexPick;
	
	float vWi, vWf, nWi, nWf;
	void ChangeWeightsQFR();
  ...
  QRadioButton *QFR_vertexPick1;
  QRadioButton *QFR_vertexPick2;

  bool nNN;
  QCheckBox *normalize_normals;
